...
1. Explain what a token is used for.
   user identification for authentication and authorization
2. What steps can you take in your web apps to keep your data secure?
   use tokens and protected routes

3. Describe how web servers work.
   web servers are both the physical computer and the code running that computer. They are identified using their ip address.
...
- **[POST]** \* to `/api/login`: returns a token to be added to the header of all other requests. Pass in the following credentials as the `body` of the request: `{ username: 'Lambda School', password: 'lambda' }`
